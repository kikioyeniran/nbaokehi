                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <p class="pageheader-text">Edit the background image, vision and mission statement of NBA OKEHI.</p>
                     ...
                     <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                         $query2 = "SELECT * FROM vision WHERE id=1";
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                          <label for="exampleFormControlTextarea1">Our Vision</label>
                                       ...
                                       <!-- <a href="#" class="btn btn-primary">Update</a> -->
                                        <input type ="submit" name = "update_vision" id= "update_vision" value="Update" class="btn btn-primary">
                                        </form>
                     </div>
