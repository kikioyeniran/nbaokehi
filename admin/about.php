                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <p class="pageheader-text">Edit the About Page of NBA OKEHI</p>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                          ...
                                          <input id="inputText3" type="text" class="form-control" name="header" value="<?php echo $row['header']?>">
                                         </div>
                                         <div class="form-group">
                                                <label for="exampleFormControlTextarea1">About Text</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="about_text"><?php echo $row['about_text']; ?></textarea>
                                        </div>
                                          <?php } ?>
